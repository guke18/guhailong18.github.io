 ...
 */
! function(e, t) {
  "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(['av'], t) : "object" == typeof exports ? exports.Valine = t() : e.Valine = t()
}(this, function(AV) {
  return function(e) {
    function t(r) {
    ...
    */
    ...
    r.prototype.init = function(e) {
      var t = this;
      return t.config = e, "undefined" == typeof document ? void console : ("undefined" == typeof AV ? u.dynamicLoadSource("script", "//cdn.jsdelivr.net/npm/leancloud-storage/dist/av-min.js", function() {
      ...
      try {
        ...
        e.el = R, e.el.classList.add("v"), m.hide && e.el.classList.add("hide-avatar"), e.config.meta = (e.config.guest_info || e.config.meta || b).filter(function(e) {
    ...
    r.prototype.Q = function(e) {
      ...
      var B = function() {
          v.comment = "", A.comment.value = "", w(A.comment), u.attr(A.comment, "placeholder", t.placeholder), R = {}, t.preview.empty().hide()
        },
